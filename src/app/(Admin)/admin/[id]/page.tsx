...
const ActionCard = ({
  ...
  return (
    <div
      className={`p-6 rounded-xl border-2 cursor-pointer transition-all duration-200 shadow-sm hover:shadow-md flex flex-col gap-2 ${colorMap[actionType]}`}
    >
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <DashboardSection title="Applications Management">
          ...
          <ActionCard
            ...
            description="Modify configurations of existing applications."
          />
          <ActionCard
            actionType="delete"
            title="Delete Application"
            description="Permanently remove an application."
          />
        </DashboardSection>
        ...
        <DashboardSection title="Members Management">
          <ActionCard
            actionType="create"
            title="Add Member"
            description="Onboard a new member to the platform."
          />
          <ActionCard
            actionType="update"
            title="Update Member"
            description="Edit member roles, profiles, and access."
          />
          <ActionCard
            actionType="delete"
            title="Remove Member"
            description="Revoke access and delete member records."
          />
        </DashboardSection>
        ...
        <DashboardSection title="Events Management">
          ...
          <ActionCard
            actionType="update"
            title="Update Event"
            description="Change dates, venues, or event details."
          />
          <ActionCard
            actionType="delete"
            title="Cancel Event"
            description="Delete an upcoming or past event."
          />
        </DashboardSection>
        ...
        <DashboardSection title="Messages & Inbox">
          <ActionCard
            actionType="view"
            title="View Messages"
            description="Read incoming user messages and inquiries."
          />
          <ActionCard
            actionType="delete"
            title="Delete Messages"
            description="Clear out old or resolved messages."
          />
        </DashboardSection>
      </main>
    </div>
